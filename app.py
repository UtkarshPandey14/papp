...
fig1=px.histogram(ss,x='Attack',nbins=20)   # nbins= how many pieces of histogram
fig2=px.line(ss,x='Name',y='Attack')
...
fig1=px.histogram(ss,x='Defense',nbins=20)   # nbins= how many pieces of histogram
fig2=px.line(ss,x='Name',y='Defense')
tabs[1].plotly_chart(fig1,use_container_width=True)
tabs[1].plotly_chart(fig2,use_container_width=True)
